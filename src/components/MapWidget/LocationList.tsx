import React, { useEffect, ChangeEvent, RefObject } from 'react';
...
declare global {
    interface Window {
        clearLocationListSelections: () => void;
    }
}
...
const LocationList: React.FC<LocationListProps> = ({ onSelectLocations, selectRef }) => {
